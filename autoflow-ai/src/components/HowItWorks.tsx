...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-28 bg-surface-dark relative overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
        {/* Header */}
        <div className="mb-20 text-center">
          <span className="text-xs font-display font-semibold tracking-[0.2em] uppercase text-primary mb-3 block">
            The Process
          </span>
        ...
        <div ref={ref} className="relative lg:grid lg:grid-cols-2 lg:gap-16">
              ...
              {steps.map((step, i) => (
                ...
                >
                  ...
                  <div className="inline-flex items-center gap-3 mb-4">
                    <span className="font-display font-extrabold text-5xl text-primary/30 leading-none">
                      {step.step}
                    </span>
          ...
          <div className="hidden lg:flex items-center">
            <div className="sticky top-32 w-full">
              <div
                className={`bg-surface rounded-2xl border border-border-light shadow-elevated overflow-hidden transition-all duration-700 ${
                  inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
                style={{ transitionDelay: inView ? "300ms" : "0ms" }}
              >
                {/* Dashboard header */}
                <div className="px-6 py-4 border-b border-border bg-base/50">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
                        <span className="font-display font-bold text-xs text-primary">D</span>
                      </div>
                      <span className="font-display font-semibold text-sm text-white">DOAI Dashboard</span>
                    </div>
                ...
                <div className="grid grid-cols-3 gap-px bg-border">
                  {[
                    ...
                    <div key={stat.label} className="bg-surface px-4 py-4 text-center">
                      ...
                      <span className="inline-block mt-1 text-xs font-semibold text-green-400 bg-green-500/10 px-1.5 py-0.5 rounded-full">
                        {stat.trend}
                      </span>
                    </div>
                  ))}
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      ...
                      <div key={item.name} className="flex items-center gap-3">
                        ...
                        <span className="font-body text-sm text-white flex-1">{item.name}</span>
                ...
                {/* Bottom bar */}
                <div className="px-6 py-3 border-t border-border bg-base/30">
                  <div className="flex items-center justify-between">
